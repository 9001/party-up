...
public class PermissionUtils {
    ...
    private static String[] getManifestPermissions(@NonNull Activity activity) {
        try {
    ...
    public static void requestAllPermissions(Activity activity) {
        ...
        if (!permissionsToRequest.isEmpty()) {
            ActivityCompat.requestPermissions(activity, permissionsToRequest.toArray(new String[0]), ALL_PERMISSIONS_REQUEST_CODE);
        }
    }
}
